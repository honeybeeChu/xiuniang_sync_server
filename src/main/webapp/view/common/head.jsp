...
<script type="text/javascript"
    ...
    <link href="${staticPath}/css/font-awesome.min.css" rel="stylesheet" media="screen">
    <link href="${staticPath}/css/navigation.css" rel="stylesheet" media="screen">
	...
	<div class="header">
		<div class="w clearfix">
			<div class="left_top fl">
				<img src="${ctxPath}/static/images/pia-logo.png" style="height:40px;width:40px;">
			</div>
			<div class="user fr">
				<div class="user-img">
					<p>
						<i class="iconfont icon-yonghu"></i><span>spark269</span><i
							class="iconfont icon-tuichu"></i><a href="" class="border-none">退出</a>
					</p>
				</div>
			</div>
		</div>
